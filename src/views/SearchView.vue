        ...
        <div class="flex-1 relative">
          <input
            ...
            class="w-full px-4 py-3 rounded-lg border-2 font-mono transition-all
              dark:bg-slate-800/50 dark:border-slate-500/50 dark:text-slate-300 dark:placeholder-slate-400/50
              dark:focus:border-accent-blue dark:focus:ring-2 dark:focus:ring-accent-blue/50
          ...
          <MagnifyingGlassIcon class="absolute right-3 top-3.5 h-5 w-5
            dark:text-slate-400/50 text-mission-400" />
        </div>
        <button
          @click="performSearch"
          ...
          class="px-6 py-3 rounded-lg font-mono font-bold transition-all disabled:opacity-50 disabled:cursor-not-allowed
            dark:bg-gradient-to-r dark:from-accent-blue dark:to-accent-teal dark:hover:shadow-lg dark:hover:shadow-slate-500/50 dark:text-white
