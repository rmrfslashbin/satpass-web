        ...
        <div v-else-if="stats" class="space-y-6">
          ...
          <div>
            <h3 class="text-lg font-bold font-mono mb-3 uppercase tracking-wide
              dark:text-slate-400 text-mission-700">
              🎯 Tracking
            </h3>
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="p-4 rounded-lg border-2
                dark:bg-accent-blue/10 dark:border-accent-blue/50
              ...
              <div class="p-4 rounded-lg border-2
                dark:bg-accent-purple/10 dark:border-accent-purple/50
                bg-yellow-50 border-yellow-300">
                <div class="text-4xl font-bold font-mono
                  dark:text-accent-purple text-yellow-700">
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div class="p-4 rounded-lg border-2
                dark:bg-slate-800/30 dark:border-slate-500/50
                bg-blue-50 border-blue-300">
                <div class="text-4xl font-bold font-mono
                  dark:text-accent-teal text-blue-700">
                  {{ stats.catalog.total_satellites.toLocaleString() }}
                </div>
                <div class="text-sm font-mono mt-1
                  dark:text-slate-400/70 text-blue-600">
                  Total Satellites
                </div>
              </div>
              <div class="p-4 rounded-lg border-2
                ...
                <div class="text-4xl font-bold font-mono
                  dark:text-accent-emerald text-green-700">
                  {{ stats.catalog.total_groups }}
                </div>
                <div class="text-sm font-mono mt-1
                  dark:text-slate-400/70 text-green-600">
                  Catalog Groups
                </div>
              </div>
            </div>
          ...
          <div v-if="stats.tle_cache">
            ...
            <div class="p-4 rounded-lg border-2 space-y-2 font-mono
              ...
              <div class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Total Entries:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
                  {{ stats.tle_cache.total_entries.toLocaleString() }}
                </span>
              </div>
              <div v-if="stats.tle_cache.newest_fetch_time" class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Last Fetch:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
              ...
              <div v-if="stats.tle_cache.newest_epoch_time" class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Newest Epoch:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
                  {{ formatDate(stats.tle_cache.newest_epoch_time) }}
                </span>
              </div>
              <div v-if="stats.tle_cache.oldest_epoch_time" class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Oldest Epoch:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
          ...
          <div v-if="stats.ground_station">
            <div class="flex items-center justify-between mb-3">
              ...
              <button
                ...
                class="px-3 py-1 text-xs font-mono font-semibold rounded-md transition-colors
                  dark:bg-accent-purple/20 dark:text-accent-purple dark:border dark:border-accent-purple/50 dark:hover:bg-accent-purple/30
            ...
            <div class="p-4 rounded-lg border-2 space-y-2 font-mono
              ...
              <div v-if="stats.ground_station.name" class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Name:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
                  {{ stats.ground_station.name }}
                </span>
              </div>
              <div class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Latitude:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
                  {{ stats.ground_station.latitude }}°
                </span>
              </div>
              <div class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Longitude:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
                  {{ stats.ground_station.longitude }}°
                </span>
              </div>
              <div class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Altitude:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
          ...
          <div v-if="stats.prediction_settings">
            ...
            <div class="p-4 rounded-lg border-2 space-y-2 font-mono
              ...
              bg-gray-50 border-gray-300">
              <div class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Min Elevation:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
                  {{ stats.prediction_settings.min_elevation_deg }}°
                </span>
              </div>
              <div class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Look Ahead:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
                  {{ stats.prediction_settings.look_ahead_days }} days
                </span>
              </div>
              <div class="flex justify-between">
                <span class="dark:text-slate-400/70 text-gray-600">Step Interval:</span>
                <span class="font-bold dark:text-slate-300 text-gray-900">
